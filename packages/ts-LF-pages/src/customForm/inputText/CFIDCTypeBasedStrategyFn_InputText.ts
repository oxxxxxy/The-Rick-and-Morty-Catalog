...
export type InputText_ClassType_OneOf = typeof InputText_String
	| typeof InputText_ExactString
;

export type InputTextStrategyObj = {
	[ prop in CFIDC_Types_InputText ]: InputText_ClassType_OneOf;
};
...
export const CFIDCTypeBasedStrategyFn_InputText = <T extends CFIDC_InputText_Base> (CFIDC_InputText: T): InputText_ClassType_OneOf => {
